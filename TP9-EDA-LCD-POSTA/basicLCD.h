...
* Entra: -
* Resulta: No genera ningún cambio en el display.
* Devuelve en su nombre FT_OK si no existe ningún e
rror.
...
óxima
* posición respetando el gap (si el carácter no es
imprimible
* lo ignora)
* Modifica: (cadd)
...
na respetando
* el gap (si algún carácter no es imprimible lo ign
ora). Si recibe una
* cadena de más de 32 caracteres, muestra los últim
os 32 en el display.
* Modifica: (cadd)
* Devuelve en su nombre una referencia a un basicLC
D que permite
...
*
* Entra: -
* Resulta: Pasa el cursor a la primera línea del di
splay sin
...
*
* Entra: -
* Resulta: Pasa el cursor a la segunda línea del di
splay sin
* alterar la columna en la que estaba.
* Modifica: (cadd).
* Devuelve en su nombre “true” si fue satisfactoria
...
or inválido
* de row y/o column ignora la instrucción (no hace
nada).
* Modifica: (cadd).
* Devuelve en su nombre “true” si fue satisfactoria
“false”
...
emos
* leer el LCD para saber dónde está el cursor. Medi
ante
...
ejemplo a
* lcdMoveCursorUp() esta última calculará un nuevo
valor
* para cadd. Este nuevo valor de cadd deberá ser tr
ansferido
